...
chromopainter.read.donor.chunk.counts <- function(chrom, dir)
...
chromopainter.read.recipient.chunk.counts <- function(chrom, dir)
...
chromopainter.read.recipient.chunk.lengths <- function(chrom, dir)
    chromopainter.read.chunk.table(list.files(path=file.path(dir, "PaintingSamples"),
