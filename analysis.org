...
** Stitch haplotypes
#+begin_src R :var reg="Poland" :var outdir="impute2-test/out-1" :var nolap=100
  hapfiles <- list.files(outdir, pattern="_haps$", full.names=TRUE)
  ids <- indivs.d$ID_1[indivs.d$reg2 == reg]
  stitch.haplotypes(hapfiles, ids, file.path(outdir, "all.hen"))
#+end_src
